...
$query="UPDATE `others` SET adno='".$adno."', name='".$name."',std='".$std."',group1='".$group1."',dateofadd='".$dateofadd."',stdofadd='".$stdofadd."',laststudied='".$laststudied."',tcno='".$tcno."',medium='".$medium."',fname='".$fname."',mname='".$mname."',religion='".$religion."',address='".$address."',dob='".$dob."',commu='".$commu."',gender='".$gender."',bg='".$bg."',state='".$state."',phone='".$phone."',ac='".$ac."',branch='".$branch."',micr='".$micr."',ifse='".$ifse."' WHERE id='".$id."'";
...
<h3><a href=\"../../ADMIN/delete/search/others.php\">Back</a></h3><h3><a href=\"../../index.html\">Back to index</a></h3><center>" ;}
