...
?>
<center>Welcome to passed students search page<br /><li>Please note give the correct spelling what you used to create with initial</li></center>
...
<form name="form2" method="post" action="#">
  ...
  ?><tr>
      ...
      <td width="88"><center><a href="../passededit.php?id=<?php echo $rowc["id"];?>"><input type="submit" class="btn-success" name="submitresult" value="Edit"></a><center></td>
