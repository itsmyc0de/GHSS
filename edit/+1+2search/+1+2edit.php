...
$query = "SELECT * FROM `+1+2` WHERE id='".$id."'";
...
<form action="+1+2editaction.php" method="post">
<fieldset>
<legend>SCHOOL DETAILS :</legend>
<table width="600" border="0" cellspacing="10" cellpadding="10">
  <tr>
    <td width="100"><input type="hidden" name="id" value="<?php echo $result['id'] ?>" />Add no :</td>
  ...
  <tr>
  <tr>
  <td>Last Studied Scool :</td>
  <td><input type="text" name="laststudied" value="<?php echo $result['laststudied'] ?>"/></td>
  </tr>
     <tr>
...
<table width="600" border="0" cellpadding="10" cellspacing="10">
  ...
  <tr>
    <td>COMMUNITY :</td>
    <td><input type="text" name="commu"  value="commu" ></td>
  </tr>
  <tr>
    <td>Gender :</td>
