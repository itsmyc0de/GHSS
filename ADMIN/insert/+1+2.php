...
$query = "INSERT INTO  `+1+2` (adno,name,std , group1 ,dateofadd ,stdofadd,tcno,laststudied,medium,fname,mname,religion,address,dob,commu,gender,bg,state,Phone,ac,branch,micr,ifse) values('".$adno."','".$name."','".$std."' , '".$group1."' , '".$dateofadd."' ,'".$stdofadd."','".$tcno."','".$laststudied."','".$medium."','".$fname."','".$mname."','".$religion."','".$address."','".$dob."','".$commu."','".$gender."','".$bg."','".$state."','".$Phone."','".$ac."','".$branch."','".$micr."','".$ifse."')";
