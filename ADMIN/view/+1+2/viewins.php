...
<body>
<center><h2>Govt higher secondary school Ambalamoola</h2><br /><h4>Student Details..</h4></center>
<?php
$id = $_REQUEST['id'];
...
<table width="803" border="1" cellpadding="5" cellspacing="5">
  ...
  <tr>
    <td width="361">Ad no :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['adno'] ?></td>
    <td width="401">Std of Addmission :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['stdofadd']?></td>
  </tr>
  <tr>
