...
<table width="803" border="1" cellpadding="5" cellspacing="5">
  ...
  <tr>
    <td width="364">Ad no :&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['adno'] ?></td>
  ...
  <tr>
    ...
    <td width="398">Address : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $result['address'] ?></td>
  </tr>
  <tr>
...
<button class="btn-success"><a href="search/search11.php">Go back</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn-danger"><a href="viewins.php">Back to main</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn-small"  onclick="window.print() ">Print the current document</button>
</center>
</body>
</html>