...
?><br /><br /><br /><center>Welcome to add students search page<br /><li>Please note give the correct spelling what you used to create with initial</li></center>
...
<form name="form2" method="post" action="#">
  ...
  ?><tr>
      ...
      <td><center><a href="../del/insertdel.php?id=<?php echo $rowc["id"];?>"><input type="submit" class="btn-danger" name="submitresult" value="Delete"></a></center></td>
      </tr>
     <?php
  }
  ?>
