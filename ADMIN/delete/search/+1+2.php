...
<link href="../../2/css/bootstrap.css" rel="stylesheet" type="text/css" />
...
?><br /><br /><br /><center>Welcome to +1+2 students search page<br /><li>Please note give the correct spelling what you used to create with initial</li></center>
...
{
	 $searchstu = mysql_query("SELECT * FROM `+1+2` where (name LIKE '$_POST[name]')");
...
<form name="form2" method="post" action="#">
  ...
  ?><tr>
      ...
      <td><a href="../del/newadd+1,+2del.php?id=<?php echo $rowc["id"];?>"><input type="submit" class="btn-danger" name="submitresult" value="Delete"></a></td>
      </tr>
     <?php
  }
  ?>
