...
?><br /><br /><br /><center>Welcome to passed students Search page<br /><li>Please note give the correct spelling what you used to create with initial</li></center>
...
{
	 $searchstu = mysql_query("SELECT * FROM passed where (name LIKE '$_POST[name]')");
...
<form name="form2" method="post" action="#">
  ...
  ?><tr>
      ...
      <td><center><a href="../del/passeddel.php?id=<?php echo $rowc["id"];?>"><input type="submit" class="btn-danger" name="submitresult" value="Delete"></a></center></td>
      </tr>
     <?php
  }
  ?>
